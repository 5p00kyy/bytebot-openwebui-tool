...
class Tools:
    ...
    class Valves(BaseModel):
        ...
        # Default Model Configuration for Task Creation
        default_model_name: str = Field(
            default="openai/Qwen3-VL-32B-Instruct",
            description="Default AI model name for task execution (e.g., openai/Qwen3-VL-32B-Instruct, openai/Browser-Use)",
        )
    ...
    class UserValves(BaseModel):
        ...
        preferred_model_name: str = Field(
            default="",
            description="Override default model (leave empty to use admin default, e.g., 'openai/Browser-Use')",
        )
    ...
    def _get_model_config(self) -> dict:
        ...
        # Use user's preferred model if set, otherwise use admin default
        model_name = (
        ...
        # Extract title from model name (after last /)
        ...
        return {
            ...
            "contextWindow": 128000,  # Standard for most models
        }
    ...
    async def get_available_models(
        ...
        Scans recent tasks to find what models are configured and available.
        Use this to see what models you can set in user preferences.
        ...
        try:
            ...
            # Get recent tasks to extract model info
            response_data = await self._retry_request(
            ...
            if not models:
                return """No model configurations found in recent tasks.

This usually means:
- No tasks have been created yet
- ByteBot needs to be configured with a model

**Current Default:** {self.valves.default_model_name}

To set a custom model, update your user preferences with:
`preferred_model_name: "openai/YourModelName"`"""

            # Format output
            output = ["**Available Models from Recent Tasks:**\n"]
            ...
            output.append(
                'Set in user preferences: `preferred_model_name: "model/name"`'
            )
